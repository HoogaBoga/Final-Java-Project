...
import org.example.Buttons.CloseForgotUser;
...
public class ForgotUserFrame extends JFrame {

    public ForgotUserFrame(){
        ...
        CloseForgotUser closeForgotUser = new CloseForgotUser(this);

        closeForgotUser.setPreferredSize(new Dimension(19, 19));
        ...
        confirmButton.addActionListener(e -> {
            ...
            boolean success = UserSessionManager.sendUsername(email);
            if (success) {
                JOptionPane.showMessageDialog(this, "Your Username has been sent to your email.", "Success", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else {
        ...
        topPanel.add(closeForgotUser, BorderLayout.EAST);
