...
public class ChangePasswordEmail extends JFrame {
    ...
    public ChangePasswordEmail(){
        ...
        CloseChangePasswordEmail closeChangePasswordEmail = new CloseChangePasswordEmail(this);

        closeChangePasswordEmail.setPreferredSize(new Dimension(19, 19));
        ...
        topPanel.add(closeChangePasswordEmail, BorderLayout.EAST);
