...
import org.example.Buttons.CloseChangePasswordEmail;
import org.example.Buttons.CloseChangeUserNameEmail;
...
public class ChangeUserNameEmail extends JFrame {

    public ChangeUserNameEmail(){

        JLabel forgot = new JLabel("Change");
        JLabel forgotPassword = new JLabel("Username?");
        JLabel emailLabel = new JLabel("Email");
        JPanel topPanel = new JPanel(new BorderLayout());
        JLabel noEmail = new JLabel("Email was not found. Please try again.");
        JButton confirmButton = new JButton("Confirm");

        CloseChangeUserNameEmail closeChangeUserNameEmail = new CloseChangeUserNameEmail(this);

        closeChangeUserNameEmail.setPreferredSize(new Dimension(19, 19));
        ...
        confirmButton.addActionListener(e -> {
            ...
            boolean success = UserSessionManager.sendUsernameResetToken(email);
            if (success) {
        ...
        topPanel.add(closeChangeUserNameEmail, BorderLayout.EAST);
